...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    ...
    console.log(`${chalk.green('                                5 Kislev, 2024')}\n`);
    console.log(`${chalk.blue('STDHEXXX BRS v1.1 || Developers method : @rapidflooder (STDHEXXX) with luvvv ^^')}`);
    console.log(`${chalk.red('Developers of method: @rapidflooder - recoding method')}\n`);
